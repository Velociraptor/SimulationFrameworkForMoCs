WindshieldSimulation: WindshieldSimulation.o actors.o giotto.o ptides.o scheduler.o
	g++ -Wall -std=c++11 -g WindshieldSimulation.o actors.o giotto.o ptides.o scheduler.o -o WindshieldSimulation
